...
> 
> 同时，能带等理论的应用革新了电子学的面貌，在1947年带来了晶体管的发明（由贝尔实验室的美国物理学家 John Bardeen（理论），Walter H. Brattain（理论）和 William B. Shockley（实验），他们因此共同获得了1956年诺贝尔物理学奖；Bardeen 还与另外两名美国理论物理学家Leon N. Cooper、John R. Schriffer一同创建了描述超导材料的BCS理论并因此再次获得1972年诺贝尔物理学奖，现在已经成为固体理论课程的一个核心内容；顺变一提，超导现象和超流体都是宏观量子效应的体现：在目前的理论里，它们本身是量子力学的结果。这方面目前比较热门的一个研究主题是BCS-BEC Crossover。），由此，在半导体物理学这一固体物理分野的影响下，电子学进入了半导体时代（见半导体物理部分），由此发展出现代电子信息科学的技术体系。
> 
> **第二阶段：20世纪中-20世纪末** 不久，随着大量关于非固相物质（比如相变流体、稠密气体、软物质、冷原子气、等离子态等）的研究得到发展，它们与固体物理间的共通性被揭示，这些研究与原本固体物理学的研究汇合为一个共同的研究领域：在1962年左右，「**凝聚态物理**」的名称开始被使用。同时，量子场论的发展带来了新的理论工具，场论的方法开始被引入凝聚态物理并成为潮流（见量子场论部分面向凝聚态的专门教材），凝聚态物理的研究由此焕然一新，成为与高能物理分庭抗礼的两大核心物理领域（可参照其他节首的解说）；这一初期的著名结果有重整化群和之前提到过的BCS理论等，两位核心人物活跃在凝聚态产生与发展的时代：苏联物理学家列夫・达维多维奇・朗道（Лев Дави́дович Ланда́у，Lev Davidovich Landau）与美国物理学家菲利普・沃伦・安德森（Philip Warren Anderson）。了解他们的学术生涯可以揭示20这个阶段至今凝聚态物理学发展的基本脉络。
> 

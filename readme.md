...
>
> 从21世纪初开始，拓扑学的研究主流逐渐趋于解体：代数几何对几何学语言的根本革新使得代数拓扑的新理论与代数几何（尤其是算术几何）的基础研究交融，以至于不分彼此（更确切地说，是代数拓扑社区被代数几何社区所吞并了）；而微分拓扑一侧一方面融入新兴的几何分析（以及较小众的动力系统），另一方面则天然地汇入辛几何以及几何表示论的热潮。可以说，往日“纯粹的”拓扑学者正趋于式微，20世纪发展出的拓扑学大厦正如19世纪的点集拓扑一般固化为基本理论，而其上新的研究则被其他社区所囊括，不再具有完全独立的地位。
> 
...
**面向物理研究者的数据分析速成**
以快速上手为目标，几部（主要面向物理）的数据分析（其实就是统计）技术的快速入门教材是
...
更理论的（相当于物理人的专用概统教材）有朱永生的两卷本《实验数据分析》；面向误差处理的专门教程则有杨旭武的《实验误差原理与数据处理》。

...
## 警告（2023年添加）
> 由初稿到现在已经经历了至少3年的时间及有多人参与的修改、增删和多种来源的资料输入，因此内容中的主观性评价存在大量偏差、错位与前后、不同部分间的不一致。整体框架的一致性已经无法维持，内容的可靠程度也低于适合专业人士选用的水平。如果您是第一次看到，在继续向下读前请务必留意这一点。
...
> 注（2024年添加）：一个可供参考的简便基干划分方式如下：
> 夫人类之知，凡文（社会人文）、理（自然）、工（工程）、农（农业）、医（医药）、军（军事）六种。其文有七类：历史、人文地理、政法、经管（含商业）、哲学（含宗教）、心学（=教育+心理+传播）、艺术；其理有七类：数学、统计、物理、化学、生物、天文、地理科学（含地球科学、大气与海洋科学等）；其工有七类：机械、电气信息、土建、生医、化工、环境、材能（材料与能动）。惟数学之中总有十支：分析、代数、几何、代数几何、数论、概率、组合、逻辑、计算（理论计算机科学/计算数学）、数学物理，而物理之中总有四支：粒子与核物理、原子分子物理、凝聚态物理、天体物理与宇宙学。凡人所学，皆归上述之列。
...
> 注（2023年添加）：此部分完成于2020年，历时久远而未再修改，之后的内容已经与此脱轨，故本章仅供背景知识较少的来者参考。
...
> 注（2023年添加）：对于想要清晰稳定自己对于所在世界的基本认识的人，有以下框架可供参考：
...
> 黎曼几何较为独特的一个当代推广理论是所谓芬斯勒（Finsler）几何，即取消了二次型限制的更一般的黎曼几何；这一分支与变分法有着密切的联系，和黎曼几何一样有广泛的应用空间，但尚未有超越黎曼几何本身的、足以震动数学界的大进展，也因此虽然曾被晚年的陈省身寄予厚望，但直到今天都没有成为数学的热门方向（但并未凋亡，仍有一些问题在做）。这方面系统的著作不多，可以参考陈省身本人及其合作者合著的一些教材，如GTM 200。
...
另一本更系统、接近教科书的同类作品则是Frédéric Paugam的Towards the Mathematics of Quantum Field Theory。
...
不过目前已经有了又新又好的一部凝聚态入门到精通（伪）一本通——兰州大学钟寅老师的《凝聚态物理学导论》讲义，文笔优雅，蔚为大观，以一千二百余页尽览凝聚态物理风华。若已略有固体物理基础，有此一一部，则可一步入（文教除外——那边有Topological Quantum了——的所有）凝聚态理论研究之门，实乃不世出之作。

...
> 精炼但比较全面，大概包含了所有传统的（即会在学校中以课程教授）的数值方法，一路到PDE数值解。

* [美国] Richard L. Burden，J. Douglas Faires，Annette M. Burden，《数值分析》（Numerical Analysis）
> 近800页的大书，比较全面和详细的美系教材，包含大量练习及近百页的部分习题答案。

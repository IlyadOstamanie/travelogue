...
> Wen学圣经（不），由量子多体理论的发展为出发点，算是对Wen本人工作（拓扑序，弦网）的一个综述。因为其中也普及了很多，几乎不需要多体基础就可以读。

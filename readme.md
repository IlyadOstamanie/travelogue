...
> 
> **第三阶段：20世纪末-今天** 安德森的最后几项重大研究之一是对1986年发现的高温超导现象的研究。高温超导是强关联电子体系的代表，而各种强关联体系超出了费米液体的经典图像，成为凝聚态理论无法直接解释的一朵「乌云」，也使得**强关联电子体系**成为21世纪后最热门的凝聚态方向之一。安德森提出的共振价键（Resonating Valence Bond，RVB）理论成为解释高温超导机制最有竞争力的候选理论之一。同样是在20世纪末，凝聚态物理学的另一朵「乌云」出现了：拓扑相变（其发现者 F. Duncan，M. Haldane与J. Michael Kosterlitz因此被授予2016物理诺奖）、拓扑物态的现象超出了传统意义上对称性的概念，挑战了从粒子图像出发的已有凝聚态理论；对这些现象的研究也造就了另一个今日凝聚态最热门的领域之一——**拓扑量子物质**，（相比起源于超导等传统现象的松散的强关联，拓扑量子物质更多地独立于已有的凝聚态理论体系之外，也因此前者的论述常常和其他主题一起散落在现有凝聚态体系下的专著中，后者则常有单独的教材，所以这里单独设节列出。）。这两朵世纪交替之时的「乌云」标志着旧有的范式已经因新的发现出现裂痕，产生了对新的理论和方法的需要。不过就目前而言，凝聚态物理的内核依然暂且可以被概括为——研究量子多体关联系统的统计性质。它最重要的基石是量子力学及其衍生的理论体系与热物理学（尤其是其现代形式统计物理学）的理论。
...
> 量子输运理论是用量子力学描述纳米尺度电子输运行为的理论，不同于经典的输运情况（热物理部分和之前的固体物理教材有好的处理），在纳米尺度下，电子输运行为往往受到量子效应的影响，这些效应包括隧穿效应、量子干涉和量子纠缠等。量子输运是与半导体技术等方面的具体应用联系很大的方向之一，所以在发展中形成了相对独立的领域，也有一些电气人在做（
* [印度] Supriyo Datta, Quantum Transport: Atom to Transistor
> 起点很低、比较友好的知名教材，作者本人的课程录像：https://www.bilibili.com/video/BV1ca411w7vV/

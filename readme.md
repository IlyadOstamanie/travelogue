...
> 如果像我一样暂时不关心具体的工程细节，那么很明显，值得首先掌握的是它们的数学与物理基础，而非绝大部分具体的力学专著。数学的基础已经被数学部分的资料（其实不需要太多（工科微积分+线性代数），最抽象的也主要就是PDE）涵盖，物理方面的基础是上述普物力学+理论力学材料涵盖的内容，而最核心的物理理论也已经包括：基本上就是之前谈到过的朗道十卷中的《流体动力学》、《弹性理论》、《连续介质电动力学》、《物理动理学》四卷的内容。
> 

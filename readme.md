...
#### 4.3.3 计算机系统技术方面
##### 4.3.3.1 计算机组成原理
> 注：一般在计算机类院系作为专业课开设，主要是从软件设计者角度来了解计算机硬件的核心部分（即处理器和存储器）的知识，个人不认同这种自上而下当作文科去学的玄学学法，一个真正的计算机技术工作者就应该对从自然界采矿炼制原料搭建计算机编写操作系统编译器开发应用软件实现算法的全套技术有一个全面（即使浅显）的认知。个人认为可以先跳过这门课而直接学习微机原理，从硬件设计角度上直接了解现代计算机系统的全貌，然后反过来将这些书作为参考来体会核心部分的工作原理。
...
##### 4.3.3.2 计算机体系结构
> 「计算机体系结构」一般在计算机类院系作为计算机组成原理的后续课开设。其内容基本上是从软件性能的角度对计算机系统的最主要部分——处理器和存储器进行优化设计的研究。
* [美国] John L. Hennessy，David A. Patterson，《计算机体系结构：量化研究方法》
> 标准的教材，查阅相关内容/备课的主流之选，几乎永远会出现在此类课程的参考材料清单上。

...
整体的顺序是这样，但是这个过程往往并不是一帆风顺的：很多时候初步的学习不足以带来运用自如的熟悉，也会遇到各种疑惑的地方。好在一切都是相互联系的——所以当我们进一步学习更深入和别处的知识时，循着相互的联系多次地解读和使用，这些疑惑和不熟悉会自然地被照亮和驱散；因此，这样的学习在局部上并不是线性的（一个主题接着一个的）：实际上，每一个主题的学习同时也是对与它相联系的所有方面的学习和熟悉。因此，最后这里的内容的成形实际上最终有赖于沉浸在各个领域当中不断摸索，直至最后逐渐探尽所有边缘（此时不会再遇到新的陌生之处），达到稳定、全面的认识。

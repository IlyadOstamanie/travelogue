...
针对同调论（以及与其衔接的同调代数），一本详实的专门中文教材是姜伯驹的《同调论》，另一部非常精炼的专著则是[加拿大] Paul Selick（多伦多大学）的Introduction to Homotopy Theory。此外 Munkres 的大部头《代数拓扑基础》（Elements of Algebraic Topology）虽然褒贬不一，但也是常见的参考书。
